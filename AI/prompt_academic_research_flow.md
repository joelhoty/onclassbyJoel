...
> **最後更新時間**: 2026-09-16 11:37:26 (UTC+8)  
...
除了呈現「**八階段漸進式提示詞鍊 (8-Stage Progressive Prompting Chain)**」與對應產出的學術研究計畫書外，本篇特別收錄**「提示詞使用優缺點深度剖析與進階升級指南」**，為中學生、大學生與科研人員提供從靈感發想、邊界推演、對抗性審查到文獻防偽的全流程 AI 協作手冊。
...
* **提示詞核心策略**：
  * **反事實推演**：若自然界演化出「飛鏢式前移」，其背後演化生存意義為何？
  * **理論突破**：突破傳統「種子必靠旋轉或翻滾減速」的直覺思維，揭示小葉欖仁因具備「階梯式輪生樹冠」，必須依靠「垂直俯衝穿透」才能破解母樹枝葉截留（Canopy Interception）魔咒，並藉由前端纖維果皮吸收撞擊力。
...
* **提示詞核心策略**：
  * **深度擴展**：將文獻探討大幅擴展為「五大跨領域核心面向」：
    ...
    2. **非對稱鈍體流體力學**：亞臨界過渡雷諾數 ($Re \approx 10^4$)、渦流脫落與 CoM-CoP 恢復力矩力學模型。
...
* **精準的防偽標註 (Anti-Hallucination Guardrails)**：
  - 初稿主動註明「研究結果與討論可省略」，有效防止 AI 自行胡亂捏造偽造實驗數據。
